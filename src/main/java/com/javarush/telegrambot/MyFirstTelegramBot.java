...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    public static final String NAME = "katrin_first_try_bot"; // TODO: добавьте имя бота в кавычках
    public static final String TOKEN = "7136230581:AAF0bHUtQePPnjTR_EKS_P71OM3ZgZ_PjtU"; //TODO: добавьте токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update updateEvent) {
        ...
        if (getCallbackQueryButtonKey().equals("step_1_btn")){
            ...
            sendTextMessageAsync(STEP_2_TEXT,
                    Map.of("Взять сосиску! +20 славы", "step_2_btn",
                            ...
                            "Сбросить банку c огурцами! +20 славы", "step_2_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_5_btn")){
            ...
            sendTextMessageAsync(STEP_6_TEXT,
                    Map.of("Бегать по крышам, снимать на GoPro! +40 славы", "step_6_btn",
                            "С GoPro напасть на других котов из засады! +40 славы", "step_6_btn",
                            "С GoPro напасть на собак из засады! +40 славы", "step_6_btn"));
        }
        ...
        if (getMessageText().equals("/glory")) {
            ...
            sendTextMessageAsync("Ваше текущее количество очков славы: " + glory);
        }
    }
